  ...
  return (
    <div>
      <main className=" w-full flex flex-col gap-16 md:gap-36 justify-center ">
        ...
        <h2 className="font-light text-[1rem] md: text-lg text-text-secondary max-w-[750px] text-pretty">As a fourth-year Interactive Arts and Technology student, I've developed a strong understanding of UI/UX design and front-end development. I'm eager to apply my skills to create engaging and user-friendly web experiences.</h2>
        </div>

        <div className="flex justify-center gap-12 mt-6">
          {contacts.map((link, index) => (
            <Link className="  text-lg  link underline" key={index} href={link.url}>{link.name}</Link>
          )) }
