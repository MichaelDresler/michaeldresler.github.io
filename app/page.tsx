  ...
  return (
    <div>
      <main className=" w-full h-[calc(100dvh-192px)]  flex items-end mb-24 ">
        ...
        <h2 className=" mt-8 font-medium text-2xl text-text-secondary tracking-[-0.05em] max-w-[32ch] ">My passion for design, coupled with a background in development, has pushed me to expand my approach beyond just aesthetics.</h2>
