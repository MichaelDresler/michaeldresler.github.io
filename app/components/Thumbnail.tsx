...
export const Thumbnail = ({
  ...
  return (
    <>
      <Link href={"/projects/surge"} className={` aspect-[16/9] flex flex-col gap-8 p-5 rounded-xl ${textColor} ${bgColor} outline-1 outline-foreground/20 duration-300 group`}>
