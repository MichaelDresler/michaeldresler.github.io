      ...
      <div className="text-text-secondary grid grid-cols-1 md:grid-cols-[0.52fr_0.6fr_1.25fr_0.5fr] mt-12">
        <div className="flex flex-col gap-6  mb-8">
          ...
          {link && (
            <a
              href={link}
              className={`${geistMono.className} hidden md:flex w-full justify-center gap-4 md:justify-between uppercase border-b border-foreground text-text-primary/80 hover:text-inverse py-4 px-2 text-center font-normal  hover:bg-foreground/90 transition-all duration-300`}
            >
              <div> View Site</div>
              <svg
