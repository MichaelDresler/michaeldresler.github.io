...
export const ProjectHero = ({
  ...
  return (
    <>
      <div className="relative medium aspect-square sm:aspect-[2.2/1] bg-white/10 rounded-xl flex justify-center overflow-hidden ">
        {/* <Image
      src={mike}
      alt="hello"
      sizes="100vw"
      ...
      <div className="text-text-secondary ">
        <div className="flex flex-col gap-4  my-16">
          <div className="font-semibold text-center text-4xl tracking-[-0.04em] text-text-primary">
            {title}
          </div>
        ...
        <h3 className="text-xl text-white font-semibold mb-4">Description</h3>
        ...
        <div className=" font-normal my-8">
          <ul>
            <div className="grid grid-cols-2 gap-4 py-4 md:py-[1.5em] border-b border-foreground/10">
              ...
              <li className="text-lg">{deliverable}</li>
            </div>
            <div className="grid grid-cols-2 gap-4 py-4 md:py-[1.5em] border-b border-foreground/10">
              <li className="text-text-primary/60 font-medium uppercase tracking-wider">
                Year
              </li>
              <li className="text-lg">{timeline}</li>
            </div>
            <div className="grid grid-cols-2 gap-4 py-4 md:py-[1.5em] border-b border-foreground/10">
              <li className="text-text-primary/60 font-medium uppercase tracking-wider">
                Role{" "}
              </li>
              <li className="max-w-[20ch] text-lg  ">
